...
print('''
        ...
        5. Добавьте вывод среднего балла по каждому предмету по определенному ученику
        6. Введите или удалите данные по оценкам, предметам и ученикам
...
while True:
    ...
    if command == 1:
        ...
        print('5. Добавьте вывод среднего балла по каждому предмету по определенному ученику')
        # цикл по предметам

        student = input('Введите имя ученика')
        # находим сумму по предмету
        marks_sum = sum(student[student][class_])
        # находим количество оценок по предмету
        marks_count = len(students_marks[student][class_])
        # выводим средний балл по предмету
    elif command == 6:
        print('6. Введите или удалите данные по оценкам, предметам и ученикам: ')
